...
<body>
<div class="container entireview">
<div class="row">
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
	...
	<div class="item active">
		<a href="#">
      <img src="<?php echo base_url('uploads')."/".$store_id."/1.jpg"; ?>" alt="Chania">
    </a>
	</div>

    <div class="item">
	<a href="#">
      <img src="<?php echo base_url('uploads')."/".$store_id."/2.jpg"; ?>" alt="Chania">
    </a>
	</div>
	
	<div class="item">
	<a href="#">
      <img src="<?php echo base_url('uploads')."/".$store_id."/3.jpg"; ?>" alt="Chania">
		</a>
	</div>
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
				...
				<span id="featuredproducts"> Featured Products</span>
				</div>
 <div class="row">
